...
int main(void) // There is absolutely no way i wrote "viod" instead of "void" cuz of this crap keyboard, anyways corrected it after reviewing this code again //
{
    ...
    printf("So this was all what i wanted to say in this intro.c, let's see if this code goes successfull (hoping so)\n");
    printf("Btw, when i was just writing this, i forgot to include semicolon until i realised that code would be fucked without semicolon lol\n");
    printf("My goal is to keep the code duct-tape free, tho i may mess up later since i'm still learning lol, literally 2 am learning as of now\n");
    return 0;
}
